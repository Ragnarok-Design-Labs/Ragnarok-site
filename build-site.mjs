...
const css = `:root{
  ...
  --accent:#6D28D9;--accent-soft:#a78bff;--warn:#d93636;
...
main{position:relative;z-index:2;min-height:calc(100svh + 160px);background:var(--bg);margin-bottom:var(--footer-reveal);box-shadow:0 28px 80px rgba(0,0,0,.18)}
...
.scroll-reveal-text .reveal-word{display:inline;opacity:var(--word-opacity,.18);transition:opacity .12s linear,color .12s linear;will-change:opacity}.hero .scroll-reveal-text .reveal-word{opacity:1!important}.scroll-reveal-text.is-complete .reveal-word{will-change:auto}.section.dark .scroll-reveal-text .reveal-word,.panel.dark .scroll-reveal-text .reveal-word{--word-opacity:.24}
...
.brand-logo{display:block;width:24px;height:24px;object-fit:contain;object-position:center}
...
.primary{display:flex;gap:24px;align-items:center}.primary a{font-family:var(--mono);font-size:11px;letter-spacing:.18em;text-transform:uppercase;color:var(--muted);padding:8px 0;position:relative}.primary a.active{color:var(--accent)}.primary a:hover{color:var(--ink)}.primary a.active:after{content:"";position:absolute;left:0;right:0;bottom:-13px;height:2px;background:var(--accent)}.menu-toggle{display:none;width:42px;height:42px;border:1px solid var(--hair);border-radius:999px;background:#fff;align-items:center;justify-content:center;gap:5px;flex-direction:column;cursor:pointer}.menu-toggle span{width:16px;height:1px;background:var(--ink);display:block}.mobile-menu{position:fixed;inset:0;z-index:80;width:100vw;height:100svh;min-height:100svh;background:rgba(255,255,255,.72);backdrop-filter:saturate(160%) blur(24px);-webkit-backdrop-filter:saturate(160%) blur(24px);color:var(--ink);opacity:0;pointer-events:none;transition:opacity .2s ease;overflow:auto}.mobile-menu:before{content:"";position:fixed;inset:0;background:linear-gradient(135deg,rgba(109,40,217,.12),rgba(255,255,255,.36) 46%,rgba(10,10,11,.06));pointer-events:none}.mobile-menu.is-open{opacity:1;pointer-events:auto}.menu-close{position:absolute;top:18px;right:20px;width:48px;height:48px;border:1px solid rgba(10,10,11,.10);border-radius:999px;background:rgba(255,255,255,.58);font-size:34px;line-height:1;color:var(--accent);cursor:pointer;display:grid;place-items:center;z-index:2}.mobile-menu-inner{position:relative;z-index:1;min-height:100svh;padding:30px 20px 24px;display:grid;align-content:space-between}.mobile-menu nav{display:grid;gap:0;margin-top:18px}.mobile-menu nav a{font-family:var(--serif);font-size:clamp(40px,12vw,64px);line-height:.9;letter-spacing:-.02em}.mobile-menu nav a.active{color:var(--accent)}.mobile-menu-services,.mobile-menu-contact{display:grid;gap:3px;font-size:14px;line-height:1.15}.mobile-menu-services span,.mobile-menu-contact span{font-family:var(--mono);font-size:10px;letter-spacing:.14em;text-transform:uppercase;color:var(--muted);margin-bottom:5px}.mobile-social{display:flex;gap:8px;margin-top:12px}.mobile-social a{width:28px;height:28px;border:1px solid var(--hair);border-radius:999px;display:grid;place-items:center;font-family:var(--mono);font-size:10px}
.btn{display:inline-flex;align-items:center;justify-content:center;gap:10px;min-height:46px;padding:0 22px;border-radius:999px;border:1px solid var(--ink);background:var(--ink);color:#fff;font-family:var(--mono);font-size:11px;letter-spacing:.14em;text-transform:uppercase;cursor:pointer;transition:transform .15s ease,background .15s ease,border-color .15s ease}.btn:hover{transform:translateY(-1px)}.btn.accent{background:var(--accent);border-color:var(--accent)}.btn.ghost{background:transparent;color:var(--ink);border-color:var(--hair)}.btn.secondary{background:transparent;color:var(--ink)}
.hero{position:relative;overflow:hidden;padding:90px 0 70px}.hero .wrap{position:relative;z-index:2}.hero-grid{display:grid;grid-template-columns:minmax(0,1.08fr) minmax(320px,.72fr);gap:64px;align-items:start}.home-hero .hero-grid{grid-template-areas:"text visual" "actions visual" "trust trust";gap:0 64px}.home-hero .hero-copy{display:contents}.home-hero .hero-text{grid-area:text;min-width:0}.home-hero .terminal{grid-area:visual;min-width:0}.home-hero .hero-actions{grid-area:actions}.home-hero .hero-trust{grid-area:trust}.hero h1{max-width:15ch}.hero .tag,.hero .tagline,.hero h1,.hero .hero-sub,.hero .hero-actions,.hero .hero-price,.hero .hero-trust{opacity:1!important;transform:none!important;will-change:auto!important}.hero-sub{margin-top:30px;max-width:58ch;color:var(--muted);font-size:clamp(16px,1.45vw,19px);line-height:1.58}.home-hero .h-display{font-size:clamp(44px,6.85vw,98px)}.home-hero .hero-sub{font-size:clamp(16px,1.5vw,19px)}.hero-actions{display:flex;gap:14px;align-items:center;flex-wrap:wrap;margin-top:34px}.hero-price{margin-top:18px}.hero-trust{margin-top:18px;max-width:72ch;line-height:1.6}.glow{position:absolute;pointer-events:none;width:920px;height:920px;border-radius:50%;background:radial-gradient(closest-side,rgba(109,40,217,.50),rgba(109,40,217,.16) 42%,transparent 70%);filter:blur(10px);top:-260px;right:-190px;z-index:0}.glow.small{width:420px;height:420px;left:-150px;top:290px;right:auto;opacity:.35}
...
.split{display:grid;grid-template-columns:1fr 1fr;gap:72px;align-items:start}.measure-list{border-top:1px solid var(--hair);margin-top:36px}.measure-list li{list-style:none;display:grid;grid-template-columns:72px minmax(220px,.75fr) minmax(0,1fr);gap:28px;align-items:start;padding:28px 0;border-bottom:1px solid var(--hair)}.measure-list .n{font-family:var(--mono);font-size:14px;color:var(--ink);letter-spacing:.02em}.measure-list .name{font-family:var(--serif);font-size:clamp(30px,3vw,48px);font-weight:400;line-height:1;letter-spacing:-.02em}.measure-list .desc{font-size:16px;color:var(--muted);line-height:1.55;margin-top:0;max-width:48ch}.measure-list.compact li{grid-template-columns:72px minmax(0,1fr);gap:28px}.measure-list.compact .name{font-size:clamp(30px,3vw,48px)}
...
.home-hero .hero-trust{width:100%;max-width:none;display:block;white-space:normal}.expertise-section{padding-top:104px;padding-bottom:104px}.expertise-grid{display:block}.expertise-intro{max-width:760px}.expertise-intro .body-lg{max-width:48ch;margin-top:24px;color:var(--muted)}.expertise-list{border-top:1px solid var(--hair);margin-top:56px}.expertise-row{display:grid;grid-template-columns:86px minmax(220px,.8fr) minmax(0,1.25fr);gap:34px;align-items:start;padding:34px 0;border-bottom:1px solid var(--hair)}.expertise-row .n{font-family:var(--mono);font-size:20px;font-weight:500;color:var(--ink)}.expertise-row h3{font-family:var(--serif);font-size:clamp(30px,3vw,48px);font-weight:400;line-height:1;letter-spacing:-.02em}.expertise-row p{font-size:16px;line-height:1.55;color:var(--muted);max-width:48ch}.measure-list.accordion details{border-bottom:1px solid var(--hair)}.measure-list.accordion summary{list-style:none;display:grid;grid-template-columns:52px 1fr auto;gap:22px;padding:22px 0;cursor:pointer}.measure-list.accordion summary::-webkit-details-marker{display:none}.measure-list.accordion .more{max-width:58ch;color:var(--muted);font-size:14px;line-height:1.55;padding:0 56px 22px 74px}.measure-list.accordion .chev{font-size:26px;line-height:1;width:26px;height:26px;display:block;transform-origin:center;transition:transform .18s ease}.measure-list.accordion details[open] .chev{transform:rotate(45deg)}.question-panel{background:var(--panel);border:1px solid var(--hair);border-radius:8px;padding:56px 60px}.question-panel .question-title{font-family:var(--serif);font-size:clamp(40px,4.4vw,66px);line-height:1.04;letter-spacing:-.02em;max-width:18ch}.question-list{margin-top:48px;border-top:1px solid rgba(0,0,0,.2)}.question-list li{list-style:none;display:grid;grid-template-columns:44px 1fr;gap:24px;padding:22px 0;border-bottom:1px solid rgba(0,0,0,.16)}.question-list .plus{font-family:var(--mono);font-size:22px;color:var(--accent)}.question-list .body{font-size:18px;color:var(--ink-2)}.restraint-section{background:var(--panel);border-top:1px solid var(--hair)}.restraint-head{display:grid;grid-template-columns:132px 1fr;gap:28px;margin-bottom:58px}.restraint-head .body-lg{margin-top:18px;color:var(--muted)}.restraint-grid{display:grid;grid-template-columns:1fr 1fr;gap:64px;align-items:start}.restraint-block:last-child{text-align:right}.restraint-block h3{font-family:var(--serif);font-size:clamp(44px,5vw,78px);line-height:.95;font-weight:400;letter-spacing:-.03em}.restraint-block ul{list-style:none;margin-top:28px;display:grid;gap:7px}.restraint-block li{font-size:15px;line-height:1.45;color:var(--ink-2)}.process-row-section{background:var(--panel);border-top:1px solid var(--hair)}.process-row-layout{display:grid;grid-template-columns:minmax(260px,.72fr) minmax(0,1fr);gap:72px;align-items:start}.process-row-copy{position:sticky;top:104px}.process-row-copy .body-lg{margin-top:24px;color:var(--muted);max-width:42ch}.process-list{border-top:1px solid var(--ink)}.process-item{display:grid;grid-template-columns:72px minmax(220px,.75fr) minmax(0,1fr);gap:28px;align-items:start;padding:30px 0;border-bottom:1px solid var(--hair)}.process-item .n{font-family:var(--mono);font-size:14px;letter-spacing:.02em;color:var(--ink)}.process-item .meta{font-family:var(--serif);font-size:clamp(30px,3vw,48px);font-weight:400;line-height:1;letter-spacing:-.02em;color:var(--ink);text-transform:none}.process-item .body{font-size:16px;line-height:1.55;color:var(--muted);max-width:48ch}.artifact .stats-grid{margin-top:18px}
footer{position:fixed;left:0;right:0;bottom:0;z-index:0;height:auto;border-top:1px solid rgba(255,255,255,.10);padding:72px 0 40px;background:#0a0a0b;color:#fff;overflow:visible}.footer-top{display:grid;grid-template-columns:1.4fr repeat(3,1fr);gap:48px}.footer-brand .word{font-family:var(--mono);font-size:13px;letter-spacing:.32em;text-transform:uppercase}.footer-symbol{width:44px;height:48px;object-fit:contain;filter:brightness(0) invert(1);opacity:.9;margin-bottom:22px}.footer-brand p{color:#b8b8c0!important}.footer-col h4{font-family:var(--mono);font-size:11px;letter-spacing:.18em;text-transform:uppercase;color:#8d8d98;margin-bottom:18px}.footer-col ul{list-style:none;display:grid;gap:12px}.footer-col a,.footer-bottom{font-size:13px;color:#b8b8c0}.wordmark{font-family:var(--serif);font-size:clamp(80px,16vw,210px);line-height:.82;letter-spacing:-.055em;margin-top:56px;color:#fff}.wordmark .accent{color:var(--accent-soft);font-style:italic}.footer-bottom{display:flex;justify-content:space-between;gap:24px;align-items:center;border-top:1px solid rgba(255,255,255,.12);padding-top:22px}.legal{display:flex;gap:24px;flex-wrap:wrap}
@media (max-width:980px){:root{--footer-reveal:820px}.wrap{padding:0 20px;max-width:100%}.primary,.header-cta{display:none}.menu-toggle{display:flex}.hero-grid,.split,.callout,.artifact-grid,.price-card-head,.does-grid,.process-row-layout{grid-template-columns:1fr}.hero-grid>*,.split>*,.callout>*,.artifact-grid>*,.does-grid>*,.process-row-layout>*{min-width:0}.home-hero .hero-grid{grid-template-columns:minmax(0,1fr);grid-template-areas:"text" "visual" "actions" "trust";gap:0}.home-hero .terminal{margin-top:28px}.home-hero .hero-actions{margin-top:28px}.home-hero .hero-trust{margin-top:16px}.hero{background:radial-gradient(circle at 78% 16%,rgba(109,40,217,.24),transparent 48%)}.glow,.glow.small{display:none}.stats-grid{grid-template-columns:repeat(3,minmax(0,1fr));gap:0}.moves,.cards-3,.packages,.signal-stack{grid-template-columns:1fr}.stat{border-right:1px solid var(--hair);border-bottom:0;padding:0 12px}.stat:first-child{padding-left:0}.stat:last-child{border-right:0;padding-right:0}.stat .n{font-size:clamp(42px,15vw,72px)}.stat .caption{font-size:12px;line-height:1.35;margin-top:10px}.stat .tag{font-size:9px;letter-spacing:.1em}.move,.card,.package{border-right:0;border-bottom:1px solid var(--hair);padding-left:0;padding-right:0}.does-copy,.expertise-intro,.process-row-copy{position:static}.signal-stack{border-left:0}.signal{border-right:0}.signal.wide{grid-column:auto}.section{padding:72px 0}.section-head,.section-head.after-audit-head{display:block}.section-head .num{margin-bottom:18px}.section-head>div:not(.num),.section-head .h-section,.section-head .body-lg{max-width:100%}.hero{padding:64px 0 58px}.hero h1,.home-hero h1{max-width:100%;font-size:clamp(46px,13.4vw,86px);overflow-wrap:normal}.hero-sub{max-width:100%}.home-hero .hero-sub{max-width:100%;font-size:clamp(16px,4.2vw,18px)}.hero-sub,.tag,.btn{overflow-wrap:anywhere}.hero-price,.hero-trust{line-height:1.6;max-width:100%}.home-hero .hero-trust{max-width:100%;width:100%}.btn{white-space:normal;text-align:center;padding:12px 16px;height:auto}.terminal,.artifact{max-width:100%}.expertise-section{padding-top:72px;padding-bottom:72px}.expertise-list{margin-top:36px}.expertise-row,.process-item,.measure-list li{grid-template-columns:44px 1fr;gap:18px;padding:20px 0}.expertise-row p,.process-item .body,.measure-list .desc{grid-column:2;font-size:14px}.expertise-row h3,.process-item .meta,.measure-list .name{font-size:clamp(28px,8vw,38px)}.measure-list.compact li{grid-template-columns:44px 1fr}.measure-list.accordion summary{grid-template-columns:40px 1fr 26px;gap:14px}.measure-list.accordion .chev{display:block;width:26px;justify-self:end;text-align:right}.measure-list.accordion .more{padding:0 0 20px 54px}.question-panel{padding:34px 24px}.question-panel .question-title{max-width:100%;font-size:clamp(36px,10vw,54px)}.question-list li{grid-template-columns:32px 1fr;gap:14px}.question-list .body{font-size:15px}.restraint-head{display:block}.restraint-grid{grid-template-columns:1fr;gap:42px}.restraint-block:last-child{text-align:left}.after-audit-head .hero-actions{margin-top:24px}.process-item .meta{grid-column:2}.price-card{padding:20px}.price-card .amount,.price-card .time{text-align:left}.checks,.form-grid{grid-template-columns:1fr}.footer-top{grid-template-columns:repeat(auto-fit,minmax(112px,1fr));gap:24px 18px}.footer-brand{grid-column:1/-1}.footer-brand .word{font-size:11px;letter-spacing:.22em}.wordmark{font-size:clamp(66px,22vw,98px);margin-top:30px}.footer-bottom{display:block}.legal{margin-top:12px;gap:14px}.brand{letter-spacing:.18em}.brand-logo{width:22px;height:22px}footer{padding:34px 0 24px}}
  ...
  return `<div class="artifact"><div class="artifact-title"><span>${label}</span><span class="badge">Actual Audit Output</span></div><div class="artifact-body artifact-grid"><div>
    ...
    <svg class="curve" viewBox="0 0 640 230" preserveAspectRatio="none" aria-label="Friction curve">
      ...
      <g font-family="JetBrains Mono" font-size="9" letter-spacing="1" fill="#9a9aa3">
        <text x="38" y="58">ENTRY</text><text x="148" y="80">VALUE</text><text x="248" y="152" fill="#6D28D9">FRICTION STEP 03</text><text x="416" y="126">COMMIT</text><text x="548" y="180">FULFILL</text>
      </g><circle cx="278" cy="166" r="4" fill="#6D28D9"/>
    </svg>
...
function processRowSection({ kicker, title, body, items }) {
  return `<section class="section process-row-section"><div class="wrap process-row-layout"><div class="process-row-copy"><div class="tag">${kicker}</div><h2 class="h-section" style="margin-top:20px">${title}</h2><p class="body-lg">${body}</p></div><div class="process-list">${items.map(([n, meta, text]) => `<div class="process-item"><span class="n">${n}</span><span class="meta">${meta}</span><p class="body">${text}</p></div>`).join("")}</div></div></section>`;
}
...
const symbolSvg = readFileSync(join(root, "assets", "symbol.svg"), "utf8");
const symbolInner = symbolSvg.match(/<svg[^>]*>([\s\S]*?)<\/svg>/)?.[1]?.replace(/style="fill:[^"]*"/g, 'style="fill:#fff"') || "";
writeFileSync(join(root, "assets", "favicon.svg"), `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 588 641"><circle cx="294" cy="320.5" r="294" fill="#6D28D9"/><g transform="translate(88 96) scale(.7)">${symbolInner}</g></svg>`);
