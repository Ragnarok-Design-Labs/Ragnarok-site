...
writeFileSync(join(root, "assets", "favicon.svg"), `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 588 641"><rect width="588" height="641" rx="96" fill="#6b2fe0"/>${symbolInner}</svg>`);
